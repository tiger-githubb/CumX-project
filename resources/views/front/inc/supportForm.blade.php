<div class="col-lg-6 contact-text py-5 wow fadeIn" data-wow-delay="0.5s">
    <div class="p-lg-5 ps-lg-0">
        <div class="section-title text-start">
            <h1 class="display-5 mb-4">Service client</h1>
        </div>
        ...
        <form action="" method="post" action="{{ route('support.send') }}">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <div class="form-floating">
                        ...
                        <label for="phone">Télephone (ajouter l'indicatif du pays)</label>
                        @if ($errors->has('phone'))
                        <div class="error">
                            {{ $errors->first('phone') }}
                        </div>
                ...
                <div class="col-12">
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Posez nous vos questions ... " class="form-control {{ $errors->has('message') ? 'error' : '' }}" name="message" id="message" rows="4" style="height: 150px" required></textarea>
                        <label for="message">Posez nous vos questions</label>
                ...
                <div class="col-12">
                    <button class="btn btn-primary-gradient bg-primary w-100 py-3" name="send" value="Submit" type="submit">Envoyer</button>
                </div>
            </div>
        </form>
    </div>
