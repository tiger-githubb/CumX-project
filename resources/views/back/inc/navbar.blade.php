            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    ...
                    @if(Auth::user()->image === null)
                        <span class="avatar avatar-sm" style="background-image: url({{ asset('/front/images/avatars/user.png') }})"></span>
                    @else
                        <span class="avatar avatar-sm" style="background-image: url({{ asset('/storage/'.Auth::user()->image) }})"></span>
                    @endif
                    ...
                    <div class="d-none d-xl-block ps-2">
                        ...
                        @else
                            <div class="mt-1 small text-muted">Editeur</div>
                        @endif
        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item   {{ Request::is('tableau-de-bord/categories') ? 'active':'' }} ">
                    ...
                    @if (Auth::user()->role === 1)
                        <li class="nav-item   {{ Request::is('tableau-de-bord/tous-les-articles') ? 'active':'' }} ">
                            <a class="nav-link" href="{{ route('alluserposts.index') }}">
                                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
