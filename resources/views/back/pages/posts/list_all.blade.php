...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Gestion de tous les articles')
            ...
            <div class="col-lg-12">
                <div class="card card-md">
                                ...
                                <table class="table" style="vertical-align: middle">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><button class="table-sort" data-sort="sort-date">Date de création</button></th>
                                            <th><button class="table-sort" data-sort="sort-user">Publié par</button></th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody class="table-tbody">
                                        ...
                                        <tr>
                                            ...
                                            <td class="sort-user">{{ $post->user_id === Auth::id() ? 'Moi' : $post->user->name }}</td>

                                            <td>
                                                <div class="btn-list flex-nowrap">

                                                    @if ($post->state === 'brouillon' && $post->user->role === 1 || $post->state === 'brouillon' && Auth::user()->role === 1)
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-10">
                            <h3 class="h1">Aucun article disponible.</h3>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const list = new List('table-default', {
            ...
            valueNames: [ 'sort-title', 'sort-category', 'sort-state', 'sort-user',
