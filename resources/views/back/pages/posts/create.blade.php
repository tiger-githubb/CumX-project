                ...
                <form class="card" action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="card-subtitle mt-3 mb-3 info">Choisissez une image 1200 et de taille légère pour un affichage optimal.</div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="resume" class="form-control @error('resume') is-invalid @enderror" placeholder="Le résumé super attirant de votre article" autofocus></textarea>
