                ...
                <form class="card" action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="color" name="color" type="color" pattern="^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$" class="form-control @error('color') is-invalid @enderror" placeholder="La couleur de votre catégorie" required autofocus>
                        ...
                        <div class="mb-3">
                            <div class="form-label required">Image mise en avant</div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea rows="4" name="desc" class="form-control @error('desc') is-invalid @enderror" placeholder="La description inspirante de votre catégorie" required autofocus></textarea>
