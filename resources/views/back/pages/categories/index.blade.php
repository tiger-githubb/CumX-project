...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Catégories')
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('category.create')}}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        Nouvelle catégorie
                        <a href="{{ route('category.create')}}" class="btn btn-primary d-sm-none btn-icon" aria-label="Nouvelle catégorie">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
            ...
            <div class="col-lg-12">
                <div class="card card-md">
                        ...
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($categories as $category)
                                    <tr>
                                        <td><a class="badge" style="background-color: {{ $category->color}}">{{ $category->name }}</a></td>

                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="{{ route('category.detail', $category->slug) }}" class="btn btn-teal w-100">
                                                ...
                                                <a href="{{ route('category.edit', $category->slug) }}" class="btn btn-purple w-100 btn-icon">
                                                ...
                                                <a href="{{ route('category.destroy', $category->id) }}" class="btn btn-pink w-100 btn-icon">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-10">
                            <h3 class="h1">Vous n'avez aucune catégorie disponible.</h3>
